...
An AI investment brain for venture capital firms. It learns how a fund thinks, discovers matching startups, maps the market, models returns, prepares diligence, and improves after every decision.
...
- **Fund brain.** Ingests prior memos, portfolio companies, rejected deals, thesis, and partner preferences. Builds an interactive graph where spatial distance means similarity.
...
- **Learning loop.** Every approve, pass, and outcome updates the brain. The graph and recommendation weights visibly change after feedback.
...
Project scaffold coming shortly. Hackathon build.
