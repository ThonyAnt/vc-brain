 ...
 */
const PARTNER_PERSONAS: { name: string; photo: string; background: string }[] = [
  {
    name: 'David Chen',
...
function partnerDisplay(name: string, index: number): { name: string; photo: string; background: string } {
