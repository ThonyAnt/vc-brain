...
`)+`
`+d);let w=A+g+a,y=A+d+o,E=gu(s,s.VERTEX_SHADER,w),b=gu(s,s.FRAGMENT_SHADER,y);s.attachShader(M,E),s.attachShader(M,b),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function C(I){if(i.debug.checkShaderErrors){let F=s.getProgramInfoLog(M)||"",q=s.getShaderInfoLog(E)||"",J=s.getShaderInfoLog(b)||"",z=F.trim(),X=q.trim(),G=J.trim(),K=!0,Q=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,E,b);else{let ht=xu(s,E,"vertex"),pt=xu(s,b,"fragment");Rt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`}});var nl,qu=Ke(()=>{In();Rs();Xu();nl=class extends sn{constructor(){super(),this.isOutputPass=!0,this.uniforms=Jn.clone(Nr.uniforms),this.material=new xs({name:Nr.name,uniforms:this.uniforms,vertexShader:Nr.vertexShader,fragmentShader:Nr.fragmentShader}),this._fsQuad=new Si(this.material),this._outputColorSpace=null,this._toneMapping=null}render(t,e,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=t.toneMappingExposure,(this._outputColorSpace!==t.outputColorSpace||this._toneMapping!==t.toneMapping)&&(this._outputColorSpace=t.outputColorSpace,this._toneMapping=t.toneMapping,this.material.defines={},Bt.getTransfer(this._outputColorSpace)===Ht&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===gr?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===_r?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===xr?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Oi?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===yr?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===Mr?this.material.defines.NEUTRAL_TONE_MAPPING="":this._toneMapping===vr&&(this.material.defines.CUSTOM_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(e),this.clear&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),this._fsQuad.render(t))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}});var J0=Sd(()=>{In();Ou();Vu();ku();Wu();qu();function b0(i){let t=i>>>0;return function(){t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}var ae=b0(20260718),Ls=i=>i[Math.floor(ae()*i.length)],Ln=[{name:"AI Infra",color:"#ff4fd8",desc:"training + inference plumbing"},{name:"Fintech",color:"#4fd6ff",desc:"money movement and risk"},{name:"Healthcare",color:"#9d6bff",desc:"care delivery and clinical ops"},{name:"Climate",color:"#5fff9d",desc:"energy, grid and industrial decarb"},{name:"DevTools",color:"#ffb347",desc:"software that builds software"},{name:"Consumer",color:"#ff6b6b",desc:"products people choose themselves"}],T0=[[0,4],[0,1],[0,2],[1,5],[3,1],[2,3],[4,1],[5,4]],E0=["Lumen","Vanta","Arc","Helio","Nimbus","Fathom","Quill","Ember","Atlas","Vertex","Sable","Orin","Pluma","Cobalt","Drift","Fern","Halcyon","Iris","Juniper","Kite","Loam","Mica","Nectar","Onyx","Prism","Rill","Signal","Tessel","Umbra","Verdant","Willow","Zephyr","Basalt","Crux","Echo","Flux","Grove","Harbor","Alder","Sorrel"],A0={0:["Compute","AI","Labs","Stack","Mind","Tensor"],1:["Pay","Finance","Ledger","Capital","Rails","Risk"],2:["Health","Bio","Care","Clinic","Genomics","Rx"],3:["Energy","Grid","Carbon","Volt","Thermal","Hydro"],4:["Dev","Ops","Forge","Build","Deploy","Test"],5:["App","Social","Shop","Play","Home","Go"]},w0=["Pre-seed","Seed","Seed","Series A"],Nn=200,Ns=12,al=47,Qu=3,Yu=new Set;function C0(i){for(;;){let t=Ls(E0)+(ae()<.35?"":" ")+Ls(A0[i]);if(!Yu.has(t))return Yu.add(t),t}}var Nc=Ln.map((i,t)=>{let e=Math.acos(1-2*(t+.5)/Ln.length),n=Math.PI*(1+Math.sqrt(5))*t,s=330;return new R(Math.sin(e)*Math.cos(n)*s,Math.cos(e)*s*.72,Math.sin(e)*Math.sin(n)*s)}),De=[];for(let i=0;i<Nn;i++){let t=i%Ln.length,e=Nc[t],n=130,s=new R(e.x+(ae()+ae()-1)*n,e.y+(ae()+ae()-1)*n*.7,e.z+(ae()+ae()-1)*n);De.push({id:i,sector:t,name:C0(t),role:"tracked",stage:Ls(w0),fit:.45+ae()*.5,base:s,offset:new R,vel:new R((ae()-.5)*6,(ae()-.5)*6,(ae()-.5)*6),pos:s.clone(),phase:ae()*Math.PI*2})}var Uc=[...De].sort(()=>ae()-.5);Uc.slice(0,Ns).forEach(i=>{i.role="portfolio",i.fit=.8+ae()*.18});Uc.slice(Ns,Ns+al).forEach(i=>{i.role="rejected"});Uc.slice(Ns+al,Ns+al+Qu).forEach(i=>{i.role="candidate",i.fit=.72+ae()*.2,i.stage="Seed"});function ol(i,t){let e=null,n=1/0;for(let s of De){if(s===i||!t(s))continue;let r=s.base.distanceToSquared(i.base);r<n&&(n=r,e=s)}return e}var Zu=new Set,cl=[];function Or(i,t,e=1){let n=Math.min(i.id,t.id)+"-"+Math.max(i.id,t.id);Zu.has(n)||(Zu.add(n),cl.push({a:i,b:t,weight:e,phase:ae()*Math.PI*2}))}for(let i of De){let t=De.filter(e=>e!==i&&e.sector===i.sector);t.sort((e,n)=>e.base.distanceToSquared(i.base)-n.base.distanceToSquared(i.base)),Or(i,t[0]),ae()<.6&&Or(i,t[1])}for(let[i,t]of T0){let e=De.filter(s=>s.sector===i),n=De.filter(s=>s.sector===t);for(let s=0;s<4;s++)Or(Ls(e),Ls(n),.6)}for(let i of De){if(i.role!=="candidate")continue;let t=ol(i,n=>n.role==="portfolio"),e=ol(i,n=>n.role==="rejected");t&&Or(i,t,1.6),e&&Or(i,e,1.2)}var Ic=new Map(De.map(i=>[i.id,new Set([i.id])]));for(let i of cl)Ic.get(i.a.id).add(i.b.id),Ic.get(i.b.id).add(i.a.id);var Us=window.matchMedia("(prefers-reduced-motion: reduce)").matches,R0=document.getElementById("app"),Ve=new Yo({antialias:!0,alpha:!0});Ve.setPixelRatio(Math.min(window.devicePixelRatio,2));Ve.setSize(window.innerWidth,window.innerHeight);Ve.setClearColor(0,0);Ve.toneMapping=Oi;Ve.toneMappingExposure=.8;R0.appendChild(Ve.domElement);var Fc=new tr,Xe=new Fe(45,window.innerWidth/window.innerHeight,1,8e3);Xe.position.set(0,170,1180);var ze=new Ko(Xe,Ve.domElement);ze.enableDamping=!0;ze.dampingFactor=.06;ze.minDistance=140;ze.maxDistance=3200;ze.autoRotate=!Us;ze.autoRotateSpeed=.45;var vn=new Hn;Fc.add(vn);var P0=Ln.map(i=>new Pt(i.color)),Ju=new Pt("#ffffff"),il=new Float32Array(Nn*3),sl=new Float32Array(Nn*3),td=new Float32Array(Nn),ed=new Float32Array(Nn),nd=new Float32Array(Nn),Oc=new Float32Array(Nn).fill(1);function Dc(i){let t=P0[i.sector].clone();return i.role==="rejected"&&t.multiplyScalar(.32),i.role==="tracked"&&t.multiplyScalar(.72),i.role==="portfolio"&&t.lerp(Ju,.12),i.role==="candidate"&&t.lerp(Ju,.35),t}De.forEach((i,t)=>{let e=Dc(i);sl[t*3]=e.r,sl[t*3+1]=e.g,sl[t*3+2]=e.b,td[t]=i.role==="portfolio"?34:i.role==="candidate"?26:i.role==="rejected"?11:15,ed[t]=i.role==="candidate"?1:0,nd[t]=i.phase});var Fn=new Me;Fn.setAttribute("position",new se(il,3).setUsage(yi));Fn.setAttribute("aColor",new se(sl,3));Fn.setAttribute("aSize",new se(td,1));Fn.setAttribute("aPulse",new se(ed,1));Fn.setAttribute("aPhase",new se(nd,1));Fn.setAttribute("aDim",new se(Oc,1).setUsage(yi));function id(i){return i.blending=Qa,i.blendEquation=En,i.blendSrc=Ms,i.blendDst=Ms,i.blendSrcAlpha=to,i.blendDstAlpha=Ms,i}var Bc=new le({transparent:!0,depthWrite:!1,uniforms:{uTime:{value:0},uMotion:{value:Us?0:1}},vertexShader:`
